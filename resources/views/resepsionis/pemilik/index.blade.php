              ...
              <tbody>
                @forelse($data as $pemilik)
                  ...
                  <div class="modal fade" id="editModal{{ $pemilik->idpemilik }}" tabindex="-1">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <form action="{{ route('resepsionis.pemilik.edit', $pemilik->idpemilik) }}" method="POST">
                          @csrf
                          ...
                          <div class="modal-body">
                            <div class="mb-3">
                              ...
                              <input type="text" name="nama" class="form-control" value="{{ $pemilik->user->nama }}"
                                required>
                            </div>
                            <div class="mb-3">
                  ...
                  <div class="modal fade" id="deleteModal{{ $pemilik->idpemilik }}" tabindex="-1">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <form action="{{ route('resepsionis.pemilik.delete', $pemilik->idpemilik) }}" method="POST">
                          @csrf
                          <div class="modal-header">
                          ...
                          <div class="modal-body">
                            <p>Apakah Anda yakin ingin menghapus data pemilik <strong>{{ $pemilik->user->nama }}</strong>?
                            </p>
